...
Арендуем по одному датацентру в Лондоне (Европа), Вирджинии (Северная Америка) и Калифорнии (Северная Америка), чтобы обеспечить покрытие основных регионов с наибольшей аудиторией.
...
Также в последнее время среди пользователей гитхаба всё больше жителей Южной Африки, поэтому можно арендовать один датацентр для этой зоны.
...
Разместим DNS-серверы в основных регионах(Северная Америка, Европа, Азия) по крайней мере 2-3 DNS-сервера в каждом регионе для обеспечения высокой доступности и отказоустойчивости, также по одному серверу в Океании и Южной Африки. 
