...
Также рассмотрим запросы из продуктовых требований для расчёта сетевой нагрузки. Для рассчёта RPS используем формулу:
...
Итого, сложив статику и запросы на бэкенд получаем:

|                              | RPS     | Трафик    |   
|------------------------------|---------|-----------|
| **Общие значения**           | 269 278 | 2.78 Гб/с |
| **При пиковой нагрузке, х2** | 538 556 | 5.56 Гб/с |
