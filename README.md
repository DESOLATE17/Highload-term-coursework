...
Для БД - CQRS, использование реплицирования и шардирования обеспечивают отказоустойчивость при многочисленных транзакциях на чтение / запись, также необходимы езервное копирование и снапшоты для возможности восстановления.
