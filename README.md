...
Рассмотрим запросы из продуктовых требований для расчёта сетевой нагрузки. Так как количество уникальных пользователей в
день составляет 13.6M, то в качестве дневной аудитории возьмём **40M**, так как часть пользователей посещает сервис
несколько раз в течение дня. Для рассчёта RPS используем формулу:
...
```
RPS: 40М / 86 400 / 7 = 66.14
Трафик: 37 * 66.14 = 2.4 Мб/с 
```
...
| Просмотр Issues                                 | 66.14 |  2.4 Мб/с  |
| **Общие значения**                              | 6743  | 0.57 Гб/с  |
| **При пиковой нагрузке, х2**                    | 13486 | 1.14 Гб/с  |
